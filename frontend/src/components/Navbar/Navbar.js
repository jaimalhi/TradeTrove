      ...
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link to="/">
          <a class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src={logoImage} class="h-8 rounded-full" alt="Flowbite Logo" />
        ...
        >
          <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-[#86A789] rounded-lg bg-[#D2E3C8] md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-[#739072] dark:bg-[#4F6F52] md:dark:bg-[#4F6F52] dark:border-[#D2E3C8]">
            ...
            {isLoggedIn === "true" ? (
               isTradie === "true" ? (
              <>
                <Link to="/tradieViewJobs">
                  <li>
                    <a class="block py-2 px-3 text-[#000000] rounded hover:bg-[#86A789] md:hover:bg-transparent md:hover:text-[#D2E3C8] md:p-0 dark:hover:text-[#D2E3C8] dark:text-white dark:hover:bg-[#4F6F52] md:dark:hover:bg-transparent dark:border-[#D2E3C8]">
                      Jobs
                    </a>
                  </li>
                </Link>
                <Link to="/tradieServicesPage">
                  <li>
                    <a class="block py-2 px-3 text-[#000000] rounded hover:bg-[#86A789] md:hover:bg-transparent md:hover:text-[#D2E3C8] md:p-0 dark:hover:text-[#D2E3C8] dark:text-white dark:hover:bg-[#4F6F52] md:dark:hover:bg-transparent dark:border-[#D2E3C8]">
                      My Services
                    </a>
            ...
            {isLoggedIn === "true" ? (<li>
                    <a class="block py-2 px-3 text-[#000000] rounded hover:bg-[#86A789] md:hover:bg-transparent md:hover:text-[#D2E3C8] md:p-0 dark:hover:text-[#D2E3C8] dark:text-white dark:hover:bg-[#4F6F52] md:dark:hover:bg-transparent dark:border-[#D2E3C8]" onClick={handleLogoutClicked}>
                      Logout
                    </a>
                  </li>) : (<></>)}
